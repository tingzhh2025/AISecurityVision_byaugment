...
- Name: API Data Validation Tests >> System Status Data Validation >> System status response structure
- Location: /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:162:5
...
Call log:
  - → GET http://localhost:8080/api/system/status
    ...
    at /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:164:45
```
