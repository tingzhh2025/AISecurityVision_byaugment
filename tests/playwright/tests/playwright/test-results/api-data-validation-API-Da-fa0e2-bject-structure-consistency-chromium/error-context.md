...
- Name: API Data Validation Tests >> Alert Data Validation >> Alert object structure consistency
- Location: /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:206:5
...
Call log:
  - → GET http://localhost:8080/api/alerts
    ...
    at /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:208:45
```
