...
- Name: API Data Validation Tests >> Error Response Validation >> Error response format consistency
- Location: /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:320:5
...
Call log:
  - → GET http://localhost:8080/api/invalid-endpoint
    ...
    at /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:324:45
```
