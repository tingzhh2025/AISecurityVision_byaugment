...
- Name: API Data Validation Tests >> Person Statistics Data Validation >> Person stats configuration validation
- Location: /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:282:5
...
Call log:
  - → POST http://localhost:8080/api/cameras/camera_01/person-stats/config
    ...
    at /userdata/source/source/AISecurityVision_byaugment/tests/playwright/api-data-validation.spec.js:292:45
```
